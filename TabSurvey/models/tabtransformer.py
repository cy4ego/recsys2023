...
class TabTransformer(BaseModelTorch):
    ...
    def __init__(self, params, args):
        ...
        dim = self.params["dim"] if args.num_features < 50 else 4
        self.batch_size = self.args.batch_size if args.num_features < 50 else 4
    ...
    def fit(self, X, y, X_val=None, y_val=None):
        ...
        val_loader = DataLoader(dataset=val_dataset, batch_size=self.val_batch_size, shuffle=True)
    ...
    def predict_helper(self, X):
        ...
        test_loader = DataLoader(dataset=test_dataset, batch_size=self.val_batch_size, shuffle=False,
                                 num_workers=2)
