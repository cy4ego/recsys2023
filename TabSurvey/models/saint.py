...
class SAINT(BaseModelTorch):
    ...
    def __init__(self, params, args):
        ...
        dim = self.params["dim"] if args.num_features < 150 else 8
        self.batch_size = self.args.batch_size if args.num_features < 150 else 64
    ...
    def fit(self, X, y, X_val=None, y_val=None):
        ...
        optimizer = optim.AdamW(self.model.parameters(), lr=0.0002)
