...
def get_parser():
    ...
    # cy4, 2023.05.05
    parser.add('--fe', type=int, default=0, help='Feature engineering method')
    parser.add('--output_dir', type=str, default="/data/recsys/2023/output/tabsurvey/v01/",
               help="output directory to save result")
    parser.add('--topk', type=int, default=20, help='topK for nearest neighbors')
    parser.add('--use_pca', action='store_true', help='Whether to use PCA Featuer')
